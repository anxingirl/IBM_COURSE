    	...
    	<table class="bigTable" border="0" bordercolor="#FFFFFF" bgcolor="#6c6c6c">
    		<thead>
    			<tr bgcolor="#c6c6c6" class="tab-head">
    				<td class="column-middle">分类类型</td><td class="column-short">分类</td><td class="column-long">类型</td>
    			</tr>
    		</thead>
    		<tbody>
    		...
    		<c:forEach var="listElement" items="${info.appCats}">
    		    <tr bgcolor="#FFFFFF" class="tab-row">
    		    	<td class="showTd">
    		    		<c:if test="${tag == '1'}">
    		    			合作项目&nbsp;&nbsp;<A class="showUp" title="新建合作项目类型">&nbsp;&nbsp;&nbsp;&nbsp;</A>
    		...
    		<tr class="tab-row addOn"  bgcolor="#FFFFFF">
    			<td><input type="hidden" value="Cat"/></td>
   		...
   		<c:set var="tag" value="1"/>
    		<c:forEach var="listElement" items="${info.techCats}">
    		    <tr bgcolor="#FFFFFF" class="tab-row">
    		    	<td class="showTd">
    		    		<c:if test="${tag == '1'}">
    		    			技术领域&nbsp;&nbsp;<A class="showUp" title="新建技术领域类型">&nbsp;&nbsp;&nbsp;&nbsp;</A>
    		    			<c:set var="tag" value='2'/>
    		    		</c:if>
    		    	</td>
    		   		 <td>
    		...
    		<tr class="tab-row addOn"  bgcolor="#FFFFFF">
    			<td><input type="hidden" value="TechCat"/></td>
    			<td><input type="text" name="text1" size=5 style={background-color:#FFD2D2} /></td>
    			<td><input type="text" name="text2" size=25 style={background-color:#FFD2D2} />
    			<a class="upload">确定添加</a>
    			</td>
    		...
    		<c:forEach var="listElement" items="${info.domainCats}">
    		    <tr bgcolor="#FFFFFF" class="tab-row">
    		    	<td class="showTd">
    		    		<c:if test="${tag == '1'}">
    		    			行业项目&nbsp;&nbsp;<A class="showUp" title="新建行业项目类型">&nbsp;&nbsp;&nbsp;&nbsp;</A>
    		    			<c:set var="tag" value='2'/>
    		    		</c:if>
    		    	</td>
    		   		 <td>
    		...
    		<tr class="tab-row addOn"  bgcolor="#FFFFFF">
    			<td><input type="hidden" value="DomainCat"/></td>
    			<td><input type="text" name="text1" size=5 style={background-color:#FFD2D2} /></td>
    			<td><input type="text" name="text2" size=25 style={background-color:#FFD2D2} />
					<a class="upload">确定添加</a>
    		</tr>
